...
class Model(nn.Module):
    ...
    def forward(self, x_enc, return_A=False):
        ...
        if return_A:
            # enc_out_dd, A_final, omega_final = self.encoder(enc_out, return_A=True)# dim_pitch == d_model
            # [REBUTTAL ADDITION] 接收用于可视化的 omega_offsets 和 g_final，不破坏原有的 omega_final
